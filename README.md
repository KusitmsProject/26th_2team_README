...
브링은 음악이라는 자극을 통해 사용자의 반응을 유도하고, 이를 인지하는 데에 도움을 줍니다. 감정이 담겨져 있는 음악을 통해 사용자를 자극함에 따라 사용자가 자신의 감정을 더 잘 이해할 수 있도록 합니다. 음악은 언어보다 수월하게 내면에 메세지를 전달할 수 있고, 감정을 투사할 수 있는 하나의 “의사소통 방법”입니다. 음악에는 또한 감정 뿐만 아니라, 삶의 이야기가 담겨집니다. 음악을 통해 같은 느낌을 공감하는 사람들 간에 연결 고리를 만들어 그들의 감정을 타인에 감정과 노래의 감정을 통해 이해 시켜 줍니다.
